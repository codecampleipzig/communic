...
export class StoreService {
  private defaultImageUrl: string = './assets/project-default.png';
  /**
  ...
  private projects: Project[] = [
    ...
    // Added data for use in retrieveExploreProjects()
    {
      id: 1,
      title: 'Project 1',
      description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum corporis aperiam, totam nemo magnam ab labore vitae natus tempora obcaecati fuga, consequatur odit autem nobis eius deserunt accusantium aspernatur. Placeat.',
  ...
  users: User[] = [
    ...
    { userName: "Iko", userEmail: "caretaker3000@gmail.com", imageURL: "../assets/serveimage.png", userId: 13 },
  ];
  ...
  /**
   * Get projects by userId where the user is neither creator nor member
   * @param userId ID of the user
   * @returns Array of project objects
   */
  retrieveExploreProjects(userId: number): Array<Project> {
    return this.projects.filter(project => project.authorID != userId && !(project.userIDs.find(user => user == userId)));
  }
